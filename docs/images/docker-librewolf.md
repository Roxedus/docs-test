...
| Parameter | Function |
| :----: | --- |
| `3000:3000` | LibreWolf desktop gui HTTP, must be proxied. |
| `3001:3001` | LibreWolf desktop gui HTTPS. |
...
| `LIBREWOLF_CLI=https://www.linuxserver.io/` | Specify one or multiple LibreWolf CLI flags, this string will be passed to the application in full. |
