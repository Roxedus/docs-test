...
<!-- Please read https://github.com/linuxserver/docker-libreoffice/blob/master/.github/CONTRIBUTING.md -->
# [linuxserver/libreoffice](https://github.com/linuxserver/docker-libreoffice)

[![Scarf.io pulls](https://scarf.sh/installs-badge/linuxserver-ci/linuxserver%2Flibreoffice?color=94398d&label-color=555555&logo-color=ffffff&style=for-the-badge&package-type=docker)](https://scarf.sh)
...
| Parameter | Function |
| :----: | --- |
| `3000:3000` | LibreOffice desktop gui HTTP, must be proxied. |
| `3001:3001` | LibreOffice desktop gui HTTPS. |
