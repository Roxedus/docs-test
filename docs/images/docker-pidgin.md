...
[![Scarf.io pulls](https://scarf.sh/installs-badge/linuxserver-ci/linuxserver%2Fpidgin?color=94398d&label-color=555555&logo-color=ffffff&style=for-the-badge&package-type=docker)](https://scarf.sh)
...
| Parameter | Function |
| :----: | --- |
| `3000:3000` | Pidgin desktop gui HTTP, must be proxied. |
| `3001:3001` | Pidgin desktop gui HTTPS. |
