...
<!-- Please read https://github.com/linuxserver/docker-yaak/blob/main/.github/CONTRIBUTING.md -->
...
[![Docker Stars](https://img.shields.io/docker/stars/linuxserver/yaak.svg?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&label=stars&logo=docker)](https://hub.docker.com/r/linuxserver/yaak)
...
| Parameter | Function |
| :----: | --- |
| `3000:3000` | Yaak desktop gui (for reverse proxy only). |
| `3001:3001` | Yaak desktop gui HTTPS. |
...
| Volume | Function |
| :----: | --- |
| `/config` | Where yaak should store its config and data. |
