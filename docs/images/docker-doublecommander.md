...
<!-- Please read https://github.com/linuxserver/docker-doublecommander/blob/master/.github/CONTRIBUTING.md -->
# [linuxserver/doublecommander](https://github.com/linuxserver/docker-doublecommander)

[![Scarf.io pulls](https://scarf.sh/installs-badge/linuxserver-ci/linuxserver%2Fdoublecommander?color=94398d&label-color=555555&logo-color=ffffff&style=for-the-badge&package-type=docker)](https://scarf.sh)
...
[![Quay.io](https://img.shields.io/static/v1.svg?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&label=linuxserver.io&message=Quay.io)](https://quay.io/repository/linuxserver.io/doublecommander)
...
| Parameter | Function |
| :----: | --- |
| `3000:3000` | Double Commander desktop gui HTTP, must be proxied. |
| `3001:3001` | Double Commander desktop gui HTTPS. |
...
* Update images:
    ...
    * Single image:
        ...
        ```bash
        docker-compose pull doublecommander
        ```
...
* Update containers:
    ...
    * Single container:
        ...
        ```bash
        docker-compose up -d doublecommander
        ```
...
* Update the image:
    ...
    ```bash
    docker pull lscr.io/linuxserver/doublecommander:latest
    ```

* Stop the running container:

    ```bash
    docker stop doublecommander
    ```

* Delete the container:

    ```bash
    docker rm doublecommander
    ```
