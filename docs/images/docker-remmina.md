...
<!-- Please read https://github.com/linuxserver/docker-remmina/blob/master/.github/CONTRIBUTING.md -->
...
| Parameter | Function |
| :----: | --- |
| `3000:3000` | Remmina desktop gui HTTP, must be proxied. |
| `3001:3001` | Remmina desktop gui HTTPS. |
